...
from ncu_report_helper_for_self_simulated_GV100_results import *
...
if __name__ == "__main__":
    ...
    # save
    workbook.save('../Self-Simulated-Results/compare_for_self_simulated_GV100_results.xlsx')
